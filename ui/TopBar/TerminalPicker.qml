...
Rectangle {
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                console.log("terminal battery1 clicked!")
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("terminal battery2 clicked!")
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("terminal battery3 clicked!")
                battery1.selected = true;
                battery2.selected = true;
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("terminal battery4 clicked!")
                battery1.selected = true;
                battery2.selected = true;
                battery3.selected = true;
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("terminal battery5 clicked!")
                battery1.selected = true;
                battery2.selected = true;
                battery3.selected = true;
                battery4.selected = true;
