...
Rectangle {
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                console.log("logs battery1 clicked!")
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("logs battery2 clicked!")
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("logs battery3 clicked!")
                battery1.selected = true;
                battery2.selected = true;
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("logss battery4 clicked!")
                battery1.selected = true;
                battery2.selected = true;
                battery3.selected = true;
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                // Calculate the desired position for the dialog
                console.log("logs battery5 clicked!")
                battery1.selected = true;
                battery2.selected = true;
                battery3.selected = true;
                battery4.selected = true;
